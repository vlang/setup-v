...
async function run(): Promise<void> {
  try {
    ...
    if (arch && !version) {
      core.warning(
        '`architecture` is provided but `version` is missing. V will be installed for the requested architecture from the default branch, and versioned caching will be skipped. To select a specific version and enable versioned caching, provide `version`.'
      )
    }
